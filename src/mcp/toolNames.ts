export const MCP_TOOL_NAMES = {
  ...
  socialPreview: "shipready.social_preview",
  generatedSiteSmells: "shipready.generated_site_smells",
  exportPatch: "shipready.export_patch",
  githubPrDraft: "shipready.github_pr_draft",
...
export const MCP_READ_ONLY_TOOL_NAMES = [
  ...
  MCP_TOOL_NAMES.socialPreview,
  MCP_TOOL_NAMES.generatedSiteSmells,
  MCP_TOOL_NAMES.exportPatch,
  MCP_TOOL_NAMES.githubPrDraft,
