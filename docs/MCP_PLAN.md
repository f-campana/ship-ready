...
src/mcp/tools.ts                    # seven read-only handlers plus one guarded write handler
...
1. All seven read-only tools, the single write tool, resources, and five prompts match this specification.
