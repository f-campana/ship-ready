...
- Full-site crawler, monitoring/scheduled crawl, terminal output polish/TUI viewer, or patch export.
...
**Pass 16: GUI polish / revisit.** Let the human UI consume proven CLI/MCP/report behavior without changing the write policy.
